...
밑줄로 표시한 행의 코드는 녹색 사과를 선택하는 데 필요한 조건을 가리킨다.
...
- 유연한 prettyPrintApple 메서드 구현하기
    ...
    public class AppleHeavyPrint imlements ApplePrint {
    	String request(Apple apple) {
...
여러가지 종류의 리스트에 필터 메서드를 사용할 수 있다.
